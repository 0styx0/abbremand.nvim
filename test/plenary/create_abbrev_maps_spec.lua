...
describe('get_abbrevs_val_trigger works correctly if', function()
    ...
    it('gets all created abbreviations', function()
        ...
        local map_value_trigger = abbremand._create_abbrev_maps()
    ...
    it('can follow values containing non-keywords to the main abbreviation map', function()
        ...
        local abbrev_map_value_trigger = abbremand._create_abbrev_maps()
    ...
    it('takes into account modified abbreviations', function()
        ...
        local map_value_trigger_updated = abbremand._create_abbrev_maps()
    ...
    it('two non-keyword-containing values with same ending can coexist', function()
        ...
        assert.contains_element(abbremand._cache.last_chunk_to_full_values[after_last_nk], same_ending_abbrs[1].value)
        assert.contains_element(abbremand._cache.last_chunk_to_full_values[after_last_nk], same_ending_abbrs[2].value)
    end)
end)
